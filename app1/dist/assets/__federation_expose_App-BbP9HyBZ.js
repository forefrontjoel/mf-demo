import { importShared } from './__federation_fn_import-BzNS59WD.js';
...
var useInsertionEffect = React$h['useInsertion' + 'Effect'] ? React$h['useInsertion' + 'Effect'] : false;
var useInsertionEffectAlwaysWithSyncFallback = useInsertionEffect || syncFallback;
useInsertionEffect || React$h.useLayoutEffect;

const React$g = await importShared('react');

const {useContext,forwardRef} = await importShared('react');
var EmotionCacheContext = /* @__PURE__ */ React$g.createContext(
...
var ThemeContext = /* @__PURE__ */ React$g.createContext({});
  ...
  return function() {
    ...
    var Styled = withEmotionCache(function(props, cache, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = React$f.useContext(ThemeContext);
      }
      ...
      newProps.ref = ref;
      return /* @__PURE__ */ React$f.createElement(React$f.Fragment, null, /* @__PURE__ */ React$f.createElement(Insertion, {
        cache,
        serialized,
        isStringTag: typeof FinalTag === "string"
      }), /* @__PURE__ */ React$f.createElement(FinalTag, newProps));
    });
 ...
 */
const useEnhancedEffect = typeof window !== 'undefined' ? React$e.useLayoutEffect : React$e.useEffect;
...
function useLazyRef(init, initArg) {
  const ref = React$b.useRef(UNINITIALIZED);
...
function useIsFocusVisible() {
  const ref = React$9.useCallback(node => {
    if (node != null) {
      prepare(node.ownerDocument);
    }
  }, []);
  const isFocusVisibleRef = React$9.useRef(false);
...
function useTheme$1(defaultTheme = null) {
  const contextTheme = React$8.useContext(ThemeContext);
...
const TransitionGroupContext = React$7.createContext(null);
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component === null) {
      return /* @__PURE__ */ React$6.createElement(TransitionGroupContext.Provider, {
        value: contextValue
      }, children);
    }
    return /* @__PURE__ */ React$6.createElement(TransitionGroupContext.Provider, {
      value: contextValue
    }, /* @__PURE__ */ React$6.createElement(Component, props, children));
  };
...
const ButtonBase = /* @__PURE__ */ React$3.forwardRef(function ButtonBase2(inProps, ref) {
  ...
  const rippleRef = React$3.useRef(null);
  ...
  const [mountedState, setMountedState] = React$3.useState(false);
  React$3.useEffect(() => {
  ...
  const keydownRef = React$3.useRef(false);
...
const ButtonGroupButtonContext = /* @__PURE__ */ React$1.createContext(void 0);
...
const App = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { onClick: () => setCount(count + 1), children: "Increment" }),
    "App: ",
    count
  ] });
};
